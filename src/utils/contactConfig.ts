export const BUSINESS_OWNER_CONTACT = {
  name: 'A&M Carpet Cleaning & Painting - Owner & Dispatch',
  ...
  whatsappUrl:
    'https://wa.me/19736094520?text=Hello%20A%26M%20Carpet%20Cleaning%20%26%20Painting!%20I%20would%20like%20to%20get%20a%20quote%20or%20book%20an%20appointment.',
  ...
  getWhatsAppBookingUrl: (bookingId?: string, customerName?: string) => {
    let msg = 'Hello A&M Carpet Cleaning & Painting!';
    if (bookingId) {
